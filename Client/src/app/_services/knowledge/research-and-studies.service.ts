...
export class ResearchAndStudiesService {
  ...
  _add(model: any | undefined) {
    ...
    return this.httpClient.post<ResponseResult>(
      this.baseUrl + 'knowledge/researchAndStudies/add',
      model,
  ...
  _update(model: any) {
    return this.httpClient.put<ResponseResult>(
      this.baseUrl + 'knowledge/researchAndStudies/update',
      model,
      this.globalService.getHttpOptions()
    );
  }
  ...
  _details(id: number) {
    return this.httpClient.get<ResponseResult>(
      this.baseUrl + 'knowledge/researchAndStudies/details?id=' + id,
      this.globalService.getHttpOptions()
    );
  }
  ...
  _delete(id: number) {
    return this.httpClient.delete<ResponseResult>(
      this.baseUrl + 'knowledge/researchAndStudies/delete?id=' + id,
      this.globalService.getHttpOptions()
    );
  }
  ...
  _list() {
    return this.httpClient.get<ResponseResult>(
      this.baseUrl + 'knowledge/researchAndStudies/listAsync',
      this.globalService.getHttpOptions()
    );
  }
}
