...
@Component({
  selector: 'app-list-register-in-program',
  standalone: true,
  imports: [FormsModule, CommonModule, TranslateModule],
  templateUrl: './list-register-in-program.component.html',
  styleUrl: './list-register-in-program.component.css',
})
export class ListRegisterInProgramComponent implements OnInit {
  @Input() listRegisterProgramViewModel: RegisterJoinProgramViewModel[] = [];
  ...
  ngOnInit(): void {
    ...
    this.joinProgramService
      ...
      .subscribe((response: ResponseResult) => {
        ...
        this.sharedService._setProgramList(participationTestViewModelList);
      });
  }
  ...
  initilizeDataTable(): void {
    ...
    const datatable: any = $('#registerInProgramDataTable').DataTable();
    // this.joinProgramService
    //   ._getProgramList()
    //   .subscribe((response: ResponseResult) => {
    //     // ////console.log(response.data, 'Data Table values');
    ...
    setTimeout(() => {
      $('#registerInProgramDataTable').DataTable({
        pagingType: 'full_numbers',
        pageLength: 5,
        processing: true,
        data: this.listRegisterProgramViewModel,
